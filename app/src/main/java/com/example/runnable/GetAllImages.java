...
public class GetAllImages {
    ...
    //JC - Method that uses JSON to retrive image urls
    ...
    //JC - method to create input stream for the Bitmaps images
    ...
    //JC - moethod that enters urls and images into arrays to be used for list adapter
